...
import com.ly723.db.helper.PagingList;
import com.ly723.db.helper.ResultSet;

import java.util.List;

/**
 * the interface below is mostly design  to handle a single table itself,
 * but if you want to do more complicated operations with more than one table,please try {@link #execQuerySQL(String, String...)}
 */

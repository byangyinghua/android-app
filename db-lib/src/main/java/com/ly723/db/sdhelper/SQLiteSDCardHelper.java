...
public abstract class SQLiteSDCardHelper extends SQLiteOpenHelper {
     ...
     *                upgrade the database
     */
    public SQLiteSDCardHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
     ...
     */
    public SQLiteSDCardHelper(Context context, String name, String storageDirectory, SQLiteDatabase.CursorFactory
